        ...
        child: LayoutBuilder(builder: (context, constraints) {
          ...
          return Container(
              ...
              child: Obx(() {
                ...
                bool isScrollableMode = constraints.maxWidth < 1000;
                ...
                if (data['inference_time_seconds'] != null) {
                  durationFormatted = "${data['inference_time_seconds']} detik";
                }

                List<Widget> infoPanelContents = [
                  // --- INFO PASIEN ---
