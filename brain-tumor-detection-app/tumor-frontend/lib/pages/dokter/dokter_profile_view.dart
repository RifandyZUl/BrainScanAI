...
class DokterProfileView extends StatefulWidget {
  const DokterProfileView({super.key});

  @override
  State<DokterProfileView> createState() => _DokterProfileViewState();
}

class _DokterProfileViewState extends State<DokterProfileView> {
